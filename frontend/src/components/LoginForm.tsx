...
const LoginForm: React.FC<LoginFormProps> = ({
  ...
  // Pre-fill email field with demo account email
  useEffect(() => {
    setEmail("abdul@example.com");
  }, []);
      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-gray-800 rounded-lg shadow-xl p-8 border border-gray-700">
            ...
            <div>
              ...
              {email === "abdul@example.com" && (
                <p className="text-xs text-gray-400 mt-1">
                  Demo account pre-filled for convenience
                </p>
              )}
            </div>
          ...
          <div className="mt-8 p-4 bg-gray-700 rounded-lg">
            <p className="text-white text-sm font-medium mb-2">Demo Account:</p>
            <p className="text-gray-300 text-sm">
              abdul@example.com / password123
            </p>
          </div>
        </div>
      </div>
