...
const AttachmentMenu: React.FC<AttachmentMenuProps> = ({
  ...
  return (
    <>
      ...
      {/* Menu */}
      <div className="absolute bottom-full right-0 mb-2 bg-gray-800 border border-gray-700 rounded-lg shadow-xl z-50 min-w-64">
        <div className="p-2">
          {/* Header */}
          <div className="flex items-center justify-between p-2 border-b border-gray-700">
            <span className="text-white text-sm font-medium">Add to conversation</span>
            <button
              onClick={onClose}
          ...
          <div className="py-2">
            ...
            {/* Add from GitHub */}
            <button
              onClick={() => { onGitHubConnect(); onClose(); }}
              className="w-full flex items-center space-x-3 p-3 text-left text-gray-300 hover:bg-gray-700 rounded-lg transition-colors"
            >
            ...
            {/* Use a project */}
            <button
              onClick={() => { onProjectSelect(); onClose(); }}
              className="w-full flex items-center justify-between p-3 text-left text-gray-300 hover:bg-gray-700 rounded-lg transition-colors"
            >
              <div className="flex items-center space-x-3">
