...
const RegisterForm: React.FC<RegisterFormProps> = ({ 
  ...
  const isFormValid = email.trim() && username.trim() && password.trim() && password === confirmPassword;
      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-gray-800 rounded-lg shadow-xl p-8 border border-gray-700">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">Join Claude and start chatting</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-12 py-3 bg-gray-700 border rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent ${
            ...
            <div className="space-y-3">
              <button
                ...
                disabled={isLoading}
                className="w-full flex items-center justify-center px-4 py-3 border border-gray-600 rounded-lg text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 focus:ring-offset-gray-800 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
